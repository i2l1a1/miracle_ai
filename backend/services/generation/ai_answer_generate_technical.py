...
..."""
    ...
    log_pipeline_step("Technical", 1, "Facts", step1_result)
...
Answer:"""
    ...
    log_pipeline_step("Technical", 2, "Draft", step2_result)
...
Corrected answer:"""
    ...
    log_pipeline_step("Technical", 3, "Final answer", step3_result)

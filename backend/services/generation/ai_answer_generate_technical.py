...
Затем перечисли ключевые факты, необходимые для ответа, в виде простого списка. Ты обязан писать факты на языке вопроса от пользователя.
...
..."""
    ...
    step2_system = SystemMessage(
        content=(
            "Ты - участник технического форума. Отвечай кратко, точно, по существу. Тон - нейтральный, строгий. "
